...
ALTER TABLE cashflows ADD UNIQUE INDEX idx_cashflows_debit (MyDate, Libelle, Debit);
ALTER TABLE cashflows ADD UNIQUE INDEX idx_cashflows_credit (MyDate, Libelle, Credit);
